...
pacman_packages=("firefox" "tree" "nvim" "vlc" "fastfetch" "kitty" "base-devel" "htop" "fd" "nodejs" "npm" "python-pip" "unzip" "wget" "curl" "zsh" "git" "lazygit" "opencode" "stow" "tmux" "hyprland" "hyprshutdown" "waybar" "wofi" "mako" "wl-clipboard" "hyprlock" "hypridle" "hyprpaper" "grim" "slurp" "brightnessctl" "playerctl" "dolphin" "wireplumber" "ttf-jetbrains-mono-nerd" "yazi" "quickshell")
